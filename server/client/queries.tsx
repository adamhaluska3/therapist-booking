...
export const getClientUpcomingSessions = async (userId: string, limit?: number): Promise<BookingWithBookingType[]> => {
...
export const getClientPreviousSessions = async (userId: string, limit?: number): Promise<BookingWithBookingType[]> => {
    const authUser = await requireUser();
    if (authUser.id !== userId) {
        throw new Error("Nemáte oprávnenie na tieto záznamy");
    }
