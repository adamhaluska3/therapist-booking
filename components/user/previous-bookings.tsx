...
export const PreviousUserBookings = async ({
  userId,
  limit,
}: {
  userId: string;
  ...
  return (
    <section>
      <div className="flex flex-row flex-wrap items-center">
        ...
        <Link
          className="text-xs md:text-xs text-brand-600 uppercase flex gap-2 items-center"
          href="/client/absolved"
        >
      ...
      {previousSessions.length === 0 && (
        <>
          <SmallInfoText
            content="Žiadne absolvované stretnutia"
