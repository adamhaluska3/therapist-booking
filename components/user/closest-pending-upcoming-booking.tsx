...
export const ClosestPendingUpcommingBooking = ({
  item,
}: ClosestPendingUpcommingBookingProps) => (
    ...
    <section className="flex flex-col gap-5 w-full flex-1">
      <div className="flex-1 flex flex-col gap-5">
        <div className="flex justify-start gap-2 items-center">
          <span className="p-2 bg-taupe-400 text-taupe-700 rounded-2xl font-bold uppercase text-xs">
            Čaká na potvrdenie
          </span>
        </div>
