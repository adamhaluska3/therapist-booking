            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent className="sm:max-w-sm">
                    ...
                    <div className="grid gap-4 py-2">
                        <p>
                            Pokúšate sa vymazať kategóriu: {name}<br/>
                        ...
                        <div className="flex flex-col">
                            ...
                            <CategoryCombobox category={newCategory} categories={categories.filter(c => c.id !== id)} onChange={(c) => setNewCategory(c)}/>
                        </div>
                    ...
                    <DialogFooter>
                        ...
                        <Button className="bg-red-700" onClick={() => {mutate(); setOpen(false)}}>
